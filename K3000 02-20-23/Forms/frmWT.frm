...
Select Case savenum
 ...
 If Me.cmbcustomer.Text = "" Then
  If MsgBox("Continue without Customer Name?", vbYesNo + vbQuestion, "Information") = vbYes Then
...
Case comEvReceive 'OnComm was triggered because characters were received
    ...
    If Len(Weight) > 0 Then 'Did we find anything to display?
        Me.txtmainkilo.Text = CStr(Mid(Weight, Int(commstr), 40))
...
containPositive = InStr(1, txtmainkilo.Text, ")0", vbTextCompare)
containPositive2 = InStr(1, txtmainkilo.Text, ")8", vbTextCompare)

containNegative = InStr(1, txtmainkilo.Text, "):", vbTextCompare)
containNegative2 = InStr(1, txtmainkilo.Text, ")2", vbTextCompare)

If Trim(Me.txtmainkilo.Text) = "" Then
    Me.txtmainkilo.Text = Mid$(Me.txtmainkilo.Text, Int(commstr), Int(commlen))
    Else
    Me.txtmidkilo.Text = Mid$(Me.txtmainkilo.Text, Int(commstr), Int(commlen))
    Me.txtmidkilo.Text = ReturnNonAlpha(Me.txtmidkilo.Text)
    If containPositive > 0 Or containPositive2 > 0 Then
    Me.txtmidkilo.Text = positive + Me.txtmidkilo.Text
    symbolize = positive
    ElseIf containNegative > 0 Or containNegative2 > 0 Then
    Me.txtmidkilo.Text = negative + Me.txtmidkilo.Text
    symbolize = negative
    End If
    End If
End Sub
...
If txtkilo.Text <> txtmidkilo.Text Then
    txtkilo.Text = ReturnNonAlpha(txtmidkilo.Text)
