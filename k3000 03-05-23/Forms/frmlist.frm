...
If listnum = 2 Then
Set rs = Nothing
rs.Open "Select * from tblweighing where status like 'OUT' and delstatus = 0 and transaction_date>='" & strDate & "' and transaction_date<='" & strDate & "' order by weighid desc ", con, 3, 3
Call listview
Set rs = Nothing
rs.Open "Select COUNT(*) as sCount from tblweighing where status like 'OUT' and delstatus = 0 and transaction_date>='" & strDate & "' and transaction_date<='" & strDate & "' order by weighid desc ", con, 3, 3
...
Case 2
Set rs = Nothing
rs.Open "Select * from tblweighing where transaction_date >='" & Format$(DTPicker1.Value, "yyyy/mm/dd") & "' and transaction_date <='" & Format$(DTPicker2.Value, "yyyy/mm/dd") & "'  and delstatus = 0 and status = 'OUT' order by weighid", con, 3, 3
Call listview
Set rs = Nothing
rs.Open "Select COUNT(*) as sCount from tblweighing where transaction_date>='" & Format$(DTPicker1.Value, "yyyy/mm/dd") & "' and transaction_date<='" & Format$(DTPicker2.Value, "yyyy/mm/dd") & "' and status = 'OUT' and delstatus = 0 order by weighid desc ", con, 3, 3
Me.Label1.Caption = "Total Items Count: " & rs!sCount
 End Select
End Sub
...
'            gross
             .SubItems(3) = rs!weigh_in & vbNullString
             .SubItems(4) = rs!weigh_out & vbNullString
            Else
'            tare
            .SubItems(3) = rs!weigh_out & vbNullString
            .SubItems(4) = rs!weigh_in & vbNullString
            End If
    
            .SubItems(5) = rs!net_weight & vbNullString
            .SubItems(6) = rs!Average & vbNullString
            .SubItems(7) = rs!customer_name & vbNullString
            .SubItems(8) = rs!product_name & vbNullString
            .SubItems(9) = rs!Destination & vbNullString
            .SubItems(10) = rs!Price & vbNullString
            .SubItems(11) = rs!totalprice & vbNullString
            .SubItems(12) = rs!qty & vbNullString
            .SubItems(13) = rs!unit & vbNullString
            .SubItems(14) = rs!datetime_weighin & vbNullString
            .SubItems(15) = rs!datetime_weighout & vbNullString
            .SubItems(16) = Format$(rs!transaction_date, "yyyy/MM/dd") & vbNullString
...
ElseIf Trim$(Me.txtsearch.Text) <> "" Then
    If Me.cboFields.Text = "Commodity" Then
     Set rs = Nothing
    rs.Open "select * from tblweighing where Product_Name like'%" & Me.txtsearch.Text & "%' AND status like '%" & weighStatus & "%' and delstatus = 0 and transaction_date>='" & Format$(DTPicker1.Value, "yyyy/mm/dd") & "' and transaction_date<='" & Format$(DTPicker2.Value, "yyyy/mm/dd") & "' order by weighid desc", con, adOpenDynamic, adLockOptimistic
       Call listview
    ElseIf Me.cboFields.Text = "Weighing No" Then
     Set rs = Nothing
    rs.Open "select * from tblweighing where consec_no like'%" & Me.txtsearch.Text & "%' AND status like '%" & weighStatus & "%' and delstatus = 0 and transaction_date>='" & Format$(DTPicker1.Value, "yyyy/mm/dd") & "' and transaction_date<='" & Format$(DTPicker2.Value, "yyyy/mm/dd") & "' order by weighid desc", con, adOpenDynamic, adLockOptimistic
       Call listview
    ElseIf Me.cboFields.Text = "Operator" Then
       Set rs = Nothing
    rs.Open "select * from tblweighing where weigher like'%" & Me.txtsearch.Text & "%' AND status like '%" & weighStatus & "%' and delstatus = 0 and transaction_date>='" & Format$(DTPicker1.Value, "yyyy/mm/dd") & "' and transaction_date<='" & Format$(DTPicker2.Value, "yyyy/mm/dd") & "' order by weighid desc", con, adOpenDynamic, adLockOptimistic
       Call listview
    Else
    Set rs = Nothing
    rs.Open "select * from tblweighing where " & Me.cboFields.Text & " like'%" & Me.txtsearch.Text & "%' AND status like '%" & weighStatus & "%' and delstatus = 0 and transaction_date>='" & Format$(DTPicker1.Value, "yyyy/mm/dd") & "' and transaction_date<='" & Format$(DTPicker2.Value, "yyyy/mm/dd") & "' order by weighid desc", con, adOpenDynamic, adLockOptimistic
       Call listview
    End If
       Else
   Call listing
