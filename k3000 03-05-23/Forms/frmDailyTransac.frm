...
DataArray(R, 6) = rsexport.Fields("average")
DataArray(R, 7) = rsexport.Fields("customer_name")
DataArray(R, 8) = rsexport.Fields("product_name")
DataArray(R, 9) = rsexport.Fields("destination")
DataArray(R, 10) = rsexport.Fields("Price")
DataArray(R, 11) = rsexport.Fields("TotalPrice")
DataArray(R, 12) = rsexport.Fields("Qty")
DataArray(R, 13) = rsexport.Fields("Unit")
DataArray(R, 14) = rsexport.Fields("DateTime_WeighIN")
DataArray(R, 15) = rsexport.Fields("Datetime_weighOut")
DataArray(R, 16) = rsexport.Fields("Status")
DataArray(R, 17) = rsexport.Fields("scale_price")
DataArray(R, 18) = rsexport.Fields("weigher")
...
oSheet.Range("A7:S7").Font.Bold = True
'oSheet.Range("A7:S7").Borders.Weight = xlHairline
oSheet.Range("A2:M2").ColumnWidth = 19
oSheet.Range("A7:S7").Value = Array("Weighing Number", "Plate Number", "Gross", "Tare", "Net Weight", "Average", "Customer", "Commodity", "Destination", "Price", "Total Price", "Quantity", "Unit", "Date/Time Weigh IN", "Date/Time Weigh OUT", "Status", "Scale Price", "Weigher Name", "Remarks")
oSheet.Range("A8").Resize(NumberOfRows, 19).Value = DataArray
