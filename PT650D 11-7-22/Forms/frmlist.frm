...
Do Until rs.EOF
    ...
    Set lst1 = Me.lvData.ListItems.Add(, , rs!weighid)
        With lst1
            ...
            .SubItems(3) = rs!weigher & vbNullString
            ...
            .SubItems(8) = rs!qty & vbNullString
            .SubItems(9) = rs!Price & vbNullString
            .SubItems(10) = rs!unit & vbNullString
            .SubItems(11) = rs!Destination & vbNullString
            .SubItems(12) = rs!totalprice & vbNullString
            .SubItems(13) = rs!datetime_weighin & vbNullString
            .SubItems(14) = rs!datetime_weighout & vbNullString
            .SubItems(15) = rs!customer_name & vbNullString
            .SubItems(16) = rs!product_name & vbNullString
            .SubItems(17) = rs!Average & vbNullString
            .SubItems(18) = rs!scale_price & vbNullString
            .SubItems(19) = rs!countnum & vbNullString
            .SubItems(20) = rs!Status & vbNullString
            .SubItems(21) = rs!Remarks & vbNullString
        End With
    rs.MoveNext
Loop
With lvData
