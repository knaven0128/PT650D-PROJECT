...
DataArray(R, 3) = rsexport.Fields("customer_name")
DataArray(R, 4) = rsexport.Fields("transaction_date")
If rsexport!weigh_in > rsexport!weigh_out Then
DataArray(R, 5) = rsexport.Fields("Weigh_IN")
DataArray(R, 6) = rsexport.Fields("Weigh_Out")
Else
DataArray(R, 5) = rsexport.Fields("Weigh_Out")
DataArray(R, 6) = rsexport.Fields("Weigh_In")
End If
DataArray(R, 7) = rsexport.Fields("Net_Weight")
DataArray(R, 8) = rsexport.Fields("average")

DataArray(R, 9) = rsexport.Fields("product_name")
DataArray(R, 10) = rsexport.Fields("destination")
DataArray(R, 11) = rsexport.Fields("Price")
DataArray(R, 12) = rsexport.Fields("TotalPrice")
DataArray(R, 13) = rsexport.Fields("Qty")
DataArray(R, 14) = rsexport.Fields("Unit")
DataArray(R, 15) = rsexport.Fields("DateTime_WeighIN")
DataArray(R, 16) = rsexport.Fields("Datetime_weighOut")
DataArray(R, 17) = rsexport.Fields("Status")
DataArray(R, 18) = rsexport.Fields("scale_price")
DataArray(R, 19) = rsexport.Fields("weigher")
DataArray(R, 20) = rsexport.Fields("Remarks")
rsexport.MoveNext
Next
Set oSheet = oBook.Worksheets(1)
oSheet.Range("A1:K1").Font.Bold = True
oSheet.Range("A8:A3000").HorizontalAlignment = &HFFFFEFDD
oSheet.Range("B8:B3000").HorizontalAlignment = &HFFFFEFDD
oSheet.Range("A1:A3000").NumberFormat = "@"
oSheet.Range("A2:K2").Font.Bold = True
oSheet.Range("A1:K1").Font.Size = 16
...
oSheet.Range("A7:T7").HorizontalAlignment = Excel.Constants.xlCenter
oSheet.Range("A7:T7").Borders(xlEdgeBottom).Weight = xlThin
oSheet.Range("A2:T2").ColumnWidth = 20
oSheet.Range("A7:T7").Value = Array("Weighing Number", "Plate Number", "Customer", "Transaction Date", "Gross", "Tare", "Net Weight", "Average", "Commodity", "Destination", "Price", "Total Price", "Quantity", "Unit", "Date/Time Weigh IN", "Date/Time Weigh OUT", "Status", "Scale Price", "Weigher Name", "Remarks")
...
Exit Sub
Err:
MsgBox "Please contact the Programmer" & vbNewLine & "System Error.", vbOKOnly, "Warning"
