...
Me.lbldatewi.Caption = Format(Now, "yyyy/MM/dd HH:MM:SS am/pm")
...
Me.lbldatewo.Visible = True
Me.lbldi.Visible = True
Me.lbldatewi.Visible = True
Me.lbldatewi.Caption = Format(Me.lbldatewi.Caption, "yyyy/MM/dd HH:MM:SS am/pm")
Me.lbldatewo.Caption = Format(Now, "yyyy/MM/dd HH:MM:SS am/pm")
End If
End If
End Sub
...
With cmd
                ...
                "DateTime_WeighOUT='" & Format(Me.lbldatewo.Caption, "yyyy/MM/dd HH:MM:SS") & "'," & _
