...
If lpIDList Then
    ...
    If iNull Then sPath = VBA.Left(sPath, iNull - 1)
End If
...
Public Sub addNewLog(user_log As String, action As String)

              With cmd
                .ActiveConnection = con
                .CommandType = adCmdText
                .CommandText = "INSERT INTO tbllogs " & _
                "(userName,actionLog)" & _
                " VALUES(" & _
                 "'" & user_log & "'," & _
                 "'" & action & "'" & _
                ")"
